...
PROGS       = afl-gcc afl-fuzz afl-replay aflnet-replay aflnet-replay-others aflnet-replay-opensshtinytls afl-showmap afl-tmin afl-gotcpu afl-analyze
...
aflnet-replay-others: aflnet-replay-others.c $(COMM_HDR) aflnet.o aflnet.h | test_x86
	$(CC) $(CFLAGS) $@.c aflnet.o decoders/open62541.c -o $@ $(LDFLAGS)

aflnet-replay-opensshtinytls: aflnet-replay-opensshtinytls.c $(COMM_HDR) aflnet.o aflnet.h | test_x86
	$(CC) $(CFLAGS) $@.c aflnet.o decoders/open62541.c -o $@ $(LDFLAGS)
